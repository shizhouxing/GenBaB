**This is a partial prerelease copy of α,β-CROWN with GenBaB implemented, for reproducing GenBaB only. Please refer to the official repository of [α,β-CROWN](https://github.com/Verified-Intelligence/alpha-beta-CROWN), which will be updated with latest GenBaB integrated in the near future, for other purposes.**
...
and [VNN-COMP 2024 results](https://github.com/ChristopherBrix/vnncomp2024_results/blob/main/SCORING/latex/results_regular_track.pdf).
...
* **BICCOS** ([Zhou et al., NeurIPS 2024](https://openreview.net/pdf?id=FwhM1Zpyft)): an effective cutting plane generation method outperforming the MIP-based cuts in GCP-CROWN.
...
α,β-CROWN is tested on Python 3.11 and PyTorch 2.3.1 (older versions, including Python 3.7 and PyTorch 1.11, may also work). It can be installed
...
**Current developers**:
* Zhouxing Shi (zshi@cs.ucla.edu), UCLA (Student Lead)
